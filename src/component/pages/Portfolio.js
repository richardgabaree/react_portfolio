          ...
          <div className="card h-100">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                {" "}
                This app is created for a animal lovers looking to adopt a dog.
                App allows you to save favorites as well as links to local
                resources.
              </p>
              <a
                href="https://richardgabaree.github.io/Project-1-Rescue-Spot/"
                target="_blank"
                rel="noreferrer"
